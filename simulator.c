...
#define RFSIMULATOR_PARAMS_DESC                                                                                                \
  {                                                                                                                            \
/*{"serveraddr",             "<ip address to connect to>\n",        simOpt,  .strptr=&rfsimulator->ip, .defstrval="127.0.0.1", \
 * TYPE_STRING,    0 },\*/
{"brokerip",
 ...
 .defstrval = "127.0.0.1",
 TYPE_STRING,
 0}, /*{"serverport",             "<port to connect to>\n",              simOpt,  .u16ptr=&(rfsimulator->port), .defuintval=PORT,
        TYPE_UINT16,    0 },\*/
    {"xsubport",
     "<port to connect to xsubsocket>\n",
     simOpt,
     .u16ptr = &(rfsimulator->xsubsocket),
     .defuintval = XSUBPORT,
     TYPE_UINT16,
     0},
    {"xpubport",
